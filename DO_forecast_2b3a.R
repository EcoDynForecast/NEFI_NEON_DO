...
y = cram.dat$dissolvedOxygen
sd = cram.dat$dissolvedOxygenExpUncert
time=ymd_hms(cram.dat$startDateTime)
...
for(t in 3:nrow(DO_proc)){
  mu[t] = mu[t-1] + (P*(1-exp(-IP*I[t]/P)) - R0 - (2.07 + 0.215*wind[t]^1.7)*(mu[t-1]-y_sat[t-1])/z[t-1])*1/24
}
